      ...
      <div class="modal_body">
        ...
        <form action="">
          <div class="form_group">
            ...
            <input class="form_control" type="text" placeholder="Please enter name card" />
          </div>
          <div class="form_group">
            <label for="">Desciption</label>
            <input class="form_control" type="text" placeholder="Please enter desciption card" />
          </div>
          <div class="form_group">
